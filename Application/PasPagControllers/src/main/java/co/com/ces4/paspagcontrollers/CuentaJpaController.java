...
public class CuentaJpaController implements Serializable {
    ...
    public void create(Cuenta cuenta) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findCuenta(cuenta.getNumero_cuenta()) != null) {
    ...
    public void edit(Cuenta cuenta) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (msg == null || msg.length() == 0) {
                String id = cuenta.getNumero_cuenta();
    ...
    public Cuenta encontrarCuentaPorPersonaJuridica (PersonaJuridica persona) {
        EntityManager em = getEntityManager();
    ...
    public Cuenta encontrarCuentaPorPersonaNatural (PersonaNatural persona) {
        EntityManager em = getEntityManager();
