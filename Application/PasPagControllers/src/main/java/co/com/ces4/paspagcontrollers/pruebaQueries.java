...
public class pruebaQueries {
    public static void main(String[] args) throws Exception {
        ...
        /*for (PersonaNatural persona  : personaJpaController.encontrarPersonaFechaMenor()) {
            System.out.println(persona);
        }*/
        
        /*for (PersonaNatural persona  : personaJpaController.EncontrarPersonaUsuario("lolo")) {
            System.out.println(persona);
        }*/
        
        /*for (PersonaNatural persona  : personaJpaController.QuincePrimerasPersonas()) {
            System.out.println(persona);
        }*/
        /*for (PersonaNatural persona  : personaJpaController.fechaMenorDosPrimerasPersonas("lolo")) {
            System.out.println(persona);
        }*/
        /*for (PersonaNatural persona  : personaJpaController.paginar(3)) {
            System.out.println(persona);
        }*/
