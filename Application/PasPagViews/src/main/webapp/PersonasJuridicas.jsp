...
<html>
    ...
    <body>
        ...
        <h1>Bienvenido</h1>
        <p>En esta sección se podrá gestionar las empresas de la pasarela de pagos</p> 
        <form role="form" method="post" action="PersonaJuridicaServlet">
                ...
                <tbody>
                    <c:forEach items="${listaPersonas}" var="persona">
                        <tr>
                            ...
                            <td> <a class="btn btn-default" href="PersonaJuridicaServlet?accion=set_data&conditional=<c:out value="1"/>&documento=<c:out value="${persona.personaPK.documento}"/>&tipo_documento=<c:out value="${persona.personaPK.tipoDocumento}"/>">Modificar</a> </td>
                            <td> <a class="btn btn-default" href="PersonaJuridicaServlet?accion=eliminar&documento=<c:out value="${persona.personaPK.documento}"/>&tipo_documento=<c:out value="${persona.personaPK.tipoDocumento}"/>">Eliminar</a> </td>
                        </tr>
                    </c:forEach> 
